...
function abrir() {
    ...
    if (window.getComputedStyle(hamburguer).display === 'none') {
...
function avancar(){
    ...
    if ((window.document.getElementsByClassName('num')[0].value == '') ||
        ...
        (window.document.getElementsByClassName('num')[6].value == '')){
         window.alert('Por favor, preencha todos os campos para avançar'); //Para prosseguir(avançar) todos os campos devem ser preenchidos / Preencha todos os campos 
    }else {
        ...
        parag.innerHTML='Insira o tempo gasto a cada execução das ações'; //a cada vez que as executa / em cada execução
...
function avancar1() {
    ...
    if ((window.document.getElementsByClassName('num')[1].value == '') ||
        ...
        window.alert('Por favor, preencha todos os campos para prosseguir'); 
    }else {
        // movimentação do simulador
        var formulario0=window.document.getElementById('formulario');
    ...
    if ((window.document.getElementById('radio1').checked == false) &&
        ...
        if (((totalitros/1000) >=0) && ((totalitros/1000) <=10)) {
            if (window.document.getElementById('radio1').checked == true) {
                var reais1 = (litros1*58)/totalitros;
                var reais2 = (litros2*58)/totalitros;
                var reais3 = (litros3*58)/totalitros;
                var reais4 = (litros4*58)/totalitros;
                var reais5 = (litros5*58)/totalitros;
                var totalvalor = 58;
            }else if (window.document.getElementById('radio2').checked == true) {
                var reais1 = (litros1*18.10)/totalitros;
                var reais2 = (litros2*18.10)/totalitros;
                var reais3 = (litros3*18.10)/totalitros;
                var reais4 = (litros4*18.10)/totalitros;
                var reais5 = (litros5*18.10)/totalitros;
                var totalvalor = 18.10;
            }else {
                var reais1 = (litros1*13.80)/totalitros;
                var reais2 = (litros2*13.80)/totalitros;
                var reais3 = (litros3*13.80)/totalitros;
                var reais4 = (litros4*13.80)/totalitros;
                var reais5 = (litros5*13.80)/totalitros;
                var totalvalor = 13.80;
            }
        // entre 11 e 20 m3
        }else if ((totalitros/1000) >=11 && (totalitros/1000) <=20) {
            if (window.document.getElementById('radio1').checked == true) {
                var reais1 = (litros1/1000)*9.08;
                var reais2 = (litros2/1000)*9.08;
                var reais3 = (litros3/1000)*9.08;
                var reais4 = (litros4/1000)*9.08;
                var reais5 = (litros5/1000)*9.08;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }else if (window.document.getElementById('radio2').checked == true) {
                var reais1 = (litros1/1000)*3.10;
                var reais2 = (litros2/1000)*3.10;
                var reais3 = (litros3/1000)*3.10;
                var reais4 = (litros4/1000)*3.10;
                var reais5 = (litros5/1000)*3.10;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }else {
                var reais1 = (litros1/1000)*1.56;
                var reais2 = (litros2/1000)*1.56;
                var reais3 = (litros3/1000)*1.56;
                var reais4 = (litros4/1000)*1.56;
                var reais5 = (litros5/1000)*1.56;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }
        // entre 21 e 30 m3
        }else if ((totalitros/1000) >=21 && (totalitros/1000 <=30)){
            if (window.document.getElementById('radio1').checked == true) {
                var reais1 = (litros1/1000)*22.66;
                var reais2 = (litros2/1000)*22.66;
                var reais3 = (litros3/1000)*22.66;
                var reais4 = (litros4/1000)*22.66;
                var reais5 = (litros5/1000)*22.66;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }else if (window.document.getElementById('radio2').checked == true) {
                var reais1 = (litros1/1000)*11.06;
                var reais2 = (litros2/1000)*11.06;
                var reais3 = (litros3/1000)*11.06;
                var reais4 = (litros4/1000)*11.06;
                var reais5 = (litros5/1000)*11.06;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }else {
                var reais1 = (litros1/1000)*5.22;
                var reais2 = (litros2/1000)*5.22;
                var reais3 = (litros3/1000)*5.22;
                var reais4 = (litros4/1000)*5.22;
                var reais5 = (litros5/1000)*5.22;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }
        // entre 31 e 50 m3
            ...
            if (window.document.getElementById('radio1').checked == true) {
                ...
                var reais1 = (litros1/1000)*15.76;
                var reais2 = (litros2/1000)*15.76;
                var reais3 = (litros3/1000)*15.76;
                var reais4 = (litros4/1000)*15.76;
                var reais5 = (litros5/1000)*15.76;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }
        // acima de 50 m3
        }else {
            if (window.document.getElementById('radio1').checked == true) {
                var reais1 = (litros1/1000)*24.96;
                var reais2 = (litros2/1000)*24.96;
                var reais3 = (litros3/1000)*24.96;
                var reais4 = (litros4/1000)*24.96;
                var reais5 = (litros5/1000)*24.96;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }else {
                var reais1 = (litros1/1000)*17.42;
                var reais2 = (litros2/1000)*17.42;
                var reais3 = (litros3/1000)*17.42;
                var reais4 = (litros4/1000)*17.42;
                var reais5 = (litros5/1000)*17.42;
                var totalvalor = (reais1+reais2+reais3+reais4+reais5);
            }
        }
